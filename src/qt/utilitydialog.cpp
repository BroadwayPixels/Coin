    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  broadway-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Broadway in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BW, 0.1 BW, 1 BW and 10 BW -- sort of like the paper money you use every day.</li> \
