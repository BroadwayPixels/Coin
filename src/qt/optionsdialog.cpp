    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BW-light"), QVariant("light"));
    ui->theme->addItem(QString("BW-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BW-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BW-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BW-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BW-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BW-traditional"), QVariant("trad"));
