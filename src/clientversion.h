...
//! These need to be macros, as clientversion.cpp's and broadway*-res.rc's voodoo requires it
...
/**
 * broadwayd-res.rc includes this file, but it cannot cope with real c++ code.
