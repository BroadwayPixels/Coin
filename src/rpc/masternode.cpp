...
UniValue masternode(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "outputs") {
        ...
        pwalletMain->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_10);
...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Broadway address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "broadway",               "masternode",             &masternode,             true,  {} },
    { "broadway",               "masternodelist",         &masternodelist,         true,  {} },
    { "broadway",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "broadway",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "broadway",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "broadway",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
