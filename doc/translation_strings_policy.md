...
This document provides guidelines for internationalization of the Broadway Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `broadway_en.ts` remains unchanged.
