...
This mechanism has been integrated into Bitcore-Node-Broadway which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/broadwaypay/insight-api-broadway#web-socket-api](https://github.com/broadwaypay/insight-api-broadway#web-socket-api)
* API: [https://github.com/broadwaypay/insight-api-broadway#instantsend-transactions](https://github.com/broadwaypay/insight-api-broadway#instantsend-transactions)
...
By default, the Broadway Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Broadway Core daemon:
